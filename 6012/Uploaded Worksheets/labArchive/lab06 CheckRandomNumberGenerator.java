...
/**
 * This class checks to see how well a random number generator works. It tests several important
 * properties, including the following.
 * 
 * the number of zeros after 10000 tries how many tries before all the numbers between 1-1000 are
 * generated the number of unique numbers generated in 1000 tries the number of odd-even pairs the
 * number of odd-odd pairs the number of even-odd pairs the number of even-even pairs the average
 * number generated
 */
...
public class CheckRandomNumberGenerator {
 ...
 /**
  * This function runs a series of tests to see how well a random number generator works.
  * 
 ...
 public void check_random(RandomNumberGenerator generator, int seed) {
  ...
  if (this.numbers_filled < this.max_size) {
   ...
   System.out
     .println("There were still " + (this.max_size - this.numbers_filled) + " indices empty\n");
  } else {
 ...
 /**
  * This function tests to see if setting the seed to the same value returns the same sequence
  * 
  * @param generator the random number generator to use
  * @return true if setting the seed to the same value returns t he same sequence, false otherwise
  */
 ...
 /**
  * This function determines how many numbers need to be generated before an array of "max_size" is
  * filled.
  * 
  * @param generator the random number generator to test.
  */
