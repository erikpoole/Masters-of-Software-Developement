...
public class BinarySearchTree<T extends Comparable<? super T>> implements SortedSet<T> {
 ...
 /**
  * recursive inner class associated with the "add" method navigates through BinarySearchTree and
  * places new element correctly
  * 
 ...
 /**
  * ensures that this set contains all items in the specified collection. utilizes .add() method
  * 
 ...
 /**
  * recursive inner class associated with the "contains" method navigates through BinarySearchTree
  * and determines if element is present
  * 
  ...
  * equal to it. utilizes .contains() method
  * 
 ...
 /**
  * recursive inner method associated with .remove() method navigates through BinarySearchTree and
  * removes input element correctly
  * 
  ...
  if (inputElement.compareTo(childNode.getElement()) < 0) {
   ...
   if (childNode.getLeft() == null && childNode.getRight() == null) {
    if (childNode == parentNode) {
     root = null;
    } else if (parentNode.getLeft() == childNode) {
 ...
 /**
  * Ensures that this set does not contain any of the items in the specified collection. Utilizes
  * .remove() method Commented code will allow for easy viewing of tree after each element is
  * removed via Graphviz
  * 
 ...
 /**
  * recursive inner method associated with "toArrayList" Navigates through BinarySearchTree and
  * returns elements in order via in-order depth-first traversal
  * 
 ...
 /**
  * Driver method generates a .dot file representing this tree uses each node's hashcode to uniquely
  * identify it
  * 
